...
public final class CommandBuilderGenerator {
    ...
    public void generateCommand(ProcessingEnvironment processingEnv, SourceCode sourceCode) {
        try (Logger logger = Logger.getLogger(processingEnv, "eu.eventstorm.event.generator", "CommandBuilderGenerator")) {
            this.logger = logger;
