...
import static eu.eventstorm.sql.impl.EventstormTransactionException.Type.COMMIT;
import static eu.eventstorm.sql.impl.EventstormTransactionException.Type.NOT_ACTIVE;
import static eu.eventstorm.sql.impl.EventstormTransactionException.Type.PREPARED_STATEMENT;
import static eu.eventstorm.sql.impl.EventstormTransactionException.Type.ROLLBACK;
