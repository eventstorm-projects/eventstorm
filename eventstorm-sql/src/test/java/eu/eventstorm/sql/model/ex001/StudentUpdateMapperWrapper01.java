...
public class StudentUpdateMapperWrapper01 implements UpdateMapperWrapper<Student> {

    @Override
    public void update(Dialect dialect, PreparedStatement ps, Student pojo) throws SQLException {
