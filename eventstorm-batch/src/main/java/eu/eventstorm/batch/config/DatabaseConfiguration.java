...
@GlobalConfiguration(flywayConfiguration = @FlywayConfiguration(database = { Db.H2,
        Db.ORACLE }, packages = "eu.eventstorm.batch.db", flyways = { @Flyway(version = "1.0.0", description = "init_schema") }))
